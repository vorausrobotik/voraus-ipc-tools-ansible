...
project = "voraus IPC Tools Ansible"
...
release = importlib_metadata.version("voraus-ipc-tools-ansible")
...
htmlhelp_basename = "voraus_ipc_tools_ansibledoc"
...
latex_documents = [
    (
        "index",
        "voraus_ipc_tools_ansible.tex",
        "voraus IPC Tools Ansible Documentation",
